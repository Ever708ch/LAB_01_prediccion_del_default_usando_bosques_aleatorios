...
def test_homework():
    ...
    #             assert d["dataset"] == "train"
    #             assert d["precision"] > 0.691
    #             assert d["balanced_accuracy"] > 0.661
    #             assert d["recall"] > 0.370
    #             assert d["f1_score"] > 0.402

    #         if i == 1:
    #             assert d["type"] == "metrics"
    #             assert d["dataset"] == "test"
    #             assert d["precision"] > 0.673
    #             assert d["balanced_accuracy"] > 0.666
    #             assert d["recall"] > 0.384
    #             assert d["f1_score"] > 0.489

    #         if i == 2:
    #             assert d["type"] == "cm_matrix"
    #             assert d["dataset"] == "train"
    #             assert (
    #                 d["true_0"]["predicted_0"]
    #                 + d["true_0"]["predicted_1"]
    #                 + d["true_1"]["predicted_0"]
    #                 + d["true_1"]["predicted_1"]
    #                 == 20953
    #             )
